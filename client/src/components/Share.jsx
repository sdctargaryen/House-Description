...
class Share extends React.Component {
  ...
  render(){
    return(
      <Modal {...this.props}>
        <Modal.Body>
          <div className={sharestyle.exit}><img className={embedstyle.exitImg} src='https://s3-us-west-1.amazonaws.com/sharebnbicons/close+icon.png' onClick={this.props.onHide}></img></div>
          <h3>Share</h3>
