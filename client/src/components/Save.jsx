  ...
  render(){
    ...
    if (this.state.cancel === false){
      ...
      return(
        <Modal {...this.props}>
        <Modal.Body >
          <div className={savestyle.exit}><img className={embedstyle.exitImg} src='https://s3-us-west-1.amazonaws.com/sharebnbicons/close+icon.png' onClick={this.closeModal}></img></div>
          <h4 className="save-modalTitle">Save to List</h4>
